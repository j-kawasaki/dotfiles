...
complete -c fcrackzip -s l -l length --description 'Use an initial password of length min, and check all passwords up to password…'
...
complete -c fcrackzip -s V -l validate --description 'Make some basic checks whether the cracker works.'
